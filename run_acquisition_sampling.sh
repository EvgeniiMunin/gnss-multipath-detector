...
octave run_realiz_fake_noise.m 400 1
echo "acquisition completed"

# execute run_data_sampler.py. generate mp/no_mp
cd ..
python3 run_data_sampler.py --mp=0 --nb_samples=200 --cn0=48 --discr=80
python3 run_data_sampler.py --mp=1 --nb_samples=200 --cn0=48 --discr=80
